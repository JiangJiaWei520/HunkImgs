...
!function(t) {
    function e(e, a, r) {
        ...
        this.on("click.pjax", e, (function(e) {
            var a = r;
            a.container || ((a = t.extend({}, r)).container = t(this).attr("data-pjax")),
            n(e, a)
        }
        ))
    }
    function n(e, n, a) {
        ...
        if (!(e.which > 1 || e.metaKey || e.ctrlKey || e.shiftKey || e.altKey || location.protocol !== i.protocol || location.hostname !== i.hostname || i.href.indexOf("#") > -1 && x(i) == x(location) || e.isDefaultPrevented())) {
            ...
            o.trigger(u, [c]),
            u.isDefaultPrevented() || (r(c),
            e.preventDefault(),
            o.trigger("pjax:clicked", [c]))
        }
    }
    function a(e, n, a) {
        a = g(n, a);
    ...
    function r(e) {
        ...
        if ("string" !== a)
            throw "expected string value for 'container' option; got " + a;
        ...
        e.success = function(a, i, u) {
            ...
            p && d && p !== d)
                ...
                (e.push || e.replace) && window.history.replaceState(r.state, h.title, h.url),
                t.contains(s, document.activeElement))
                    try {
                        document.activeElement.blur()
                    } catch (t) {}
                h.title && (document.title = h.title),
                c("pjax:beforeReplace", [h.contents, e], {
                    state: r.state,
                    previousState: l
                }),
                s.html(h.contents);
                ...
                "number" == typeof g && t(window).scrollTop(g),
                c("pjax:success", [a, i, u, e])
            } else
                o(h.url)
        }
        ,
        ...
        return p.readyState > 0 && (e.push && !e.replace && (u = r.state.id,
        l = [e.container, h(s)],
        b[u] = l,
        E.push(u),
        S(T, 0),
        S(E, r.defaults.maxCacheLength),
    ...
    function g(e, n) {
        return e && n ? ((n = t.extend({}, n)).container = e,
    ...
    function w(e, n, a) {
        var r, i, o = {}, s = /<html/i.test(e), c = n.getResponseHeader("X-PJAX-URL");
        if (o.url = c ? m(v(c)) : a.requestUrl,
        s) {
        ...
        if (0 === i.length)
            return o;
        if (o.title = y(r, "title").last().text(),
        a.fragment) {
            var l = i;
            "body" !== a.fragment && (l = y(l, a.fragment).first()),
            l.length && (o.contents = "body" === a.fragment ? l : l.contents(),
        ...
        o.scripts = y(o.contents, "script[src]").remove(),
        o.contents = o.contents.not(o.scripts)),
        o.title && (o.title = t.trim(o.title)),
        o
    }
    u && u.container && (r.state = u),
