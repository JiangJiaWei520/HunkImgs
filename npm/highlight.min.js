...
!function(e) {
    ...
    function _(e, t, r) {
        ...
        for (; e.length || t.length; ) {
            var d = s();
            if (n += M(r.substring(a, d[0].offset)),
            a = d[0].offset,
            d === e) {
                for (i.reverse().forEach(o); l(d.splice(0, 1)[0]),
    ...
    function B(t, i, n, e) {
        ...
        function s() {
            m += null != p.sL ? function() {
                ...
                return 0 < p.relevance && (_ += t.relevance),
                e && (f[p.sL] = t.top),
                ...
                r = p.lR.exec(g); r; )
                    ...
                    (e = n.k.hasOwnProperty(s) && n.k[s]) ? (_ += e[1],
                    a += c(e[0], M(r[0]))) : a += M(r[0]),
                    t = p.lR.lastIndex,
                    r = p.lR.exec(g);
        ...
        function l(e) {
            var t = e[0]
              , r = e.rule;
            return r && r.endSameAsBegin && (r.eR = new RegExp(t.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"),"m")),
            r.skip ? g += t : (r.eB && (g += t),
            s(),
            r.rB || r.eB || (g = t)),
            o(r),
        ...
        function d(e) {
            ...
            if (a) {
                var n = p;
                for (n.skip ? g += t : (n.rE || n.eE || (g += t),
                s(),
                n.eE && (g = t)); p.cN && (m += k),
                p.skip || p.sL || (_ += p.relevance),
                (p = p.parent) !== a.parent; )
                    ;
                return a.starts && (a.endSameAsBegin && (a.starts.eR = a.eR),
                o(a.starts)),
                n.rE ? 0 : t.length
            }
        }
        ...
        function r(e, t) {
            ...
            null == r)
                return s(),
                0;
            if ("begin" == u.type && "end" == t.type && u.index == t.index && "" === r)
                return g += i.slice(t.index, t.index + 1),
                1;
            if ("begin" === (u = t).type)
                return l(t);
            if ("illegal" === t.type && !n)
        ...
        var b = A(t);
        if (!b)
            throw console.error(x.replace("{}", t)),
            new Error('Unknown language: "' + t + '"');
        C(b);
        var a, p = e || b, f = {}, m = "";
        for (a = p; a !== b; a = a.parent)
            a.cN && (m = c(a.cN, "", !0) + m);
        var g = ""
          , _ = 0;
        try {
            for (var h, v, y = 0; p.t.lastIndex = y,
            h = p.t.exec(i); )
                v = r(i.substring(y, h.index), h),
                y = h.index + v;
            for (r(i.substr(y)),
            a = p; a.parent; a = a.parent)
                a.cN && (m += k);
            return {
                relevance: _,
                value: m,
    ...
    function d(e) {
        var t, r, a, n, i, s, c, o, l, d, u = function(e) {
            ...
            r = p.exec(i)) {
                var s = A(r[1]);
                return s || (console.warn(x.replace("{}", r[1])),
        ...
        i = t.textContent,
        a = u ? B(u, i, !0) : R(i),
        (r = g(t)).length && ((n = document.createElement("div")).innerHTML = a.value,
        a.value = _(r, g(n), i)),
        a.value = v(a.value),
        e.innerHTML = a.value,
